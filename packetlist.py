...
def dec_packet_count(packet_array):
    """
...
def inc_uncollided_packet_count(packet_array):
    """
...
def binsplit_uncollided_packet_count(packet_array, branchprob):
    """
...
def sort_packet_array(packet_array):
    """
