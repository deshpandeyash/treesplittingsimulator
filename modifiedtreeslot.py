...
class ModifiedTreeSlot(object):
    ...
    def oneslotprocess(self, arrival_array, prev_slot_collsion, printit=False):
        """
        ...
        # If Idle
            ...
            arrival_array = packetlist.dec_packet_count(arrival_array)
            if prev_slot_collsion:
                # Increment uncollided packets
                arrival_array = packetlist.inc_uncollided_packet_count(arrival_array)
                # Do the binary split again
